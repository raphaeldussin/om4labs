...
def plot(dset_out):
    ...
    plt.plot(x_end,mean_Donohue,marker="o",markersize=10,markerfacecolor='grey',markeredgecolor='k')
    plt.plot(x_end,mean_Xu,marker="o",markersize=10,markerfacecolor='yellow',markeredgecolor='k')
    plt.plot(x_end,mean_BSOSE,marker="o",markersize=10,markerfacecolor='cyan',markeredgecolor='k')
    ...
    fig.text(0.92,0.55,'Xu et al. 2021 (1/12th HYCOM)', fontsize=12, color='black', fontweight='bold')
